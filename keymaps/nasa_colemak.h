...
const keymap_t keymap_cyrillic[128] PROGMEM = {
  KEY__,                        // --- ----  0x00 no keys pressed
  KEY_D,                        // --- ---P  0x01 в
  KEY_Z,                        // --- --R-  0x02 я
  KEY_E,                        // --- --RP  0x03 у
  ...
  MODE_FUNC,                    // --N ---P  0x11
  KEY_esc,                      // --N --R-  0x12
  FORCE_LSHIFT|KEY_4,           // --N --RP  0x13 ;
  FORCE_LSHIFT|KEY_slash,       // --N -M--  0x14 ,
  KEY_rbr,                      // --N -M-P  0x15 ъ
  KEY_slash,                    // --N -MR-  0x16 .
  MOD_LALT,                     // --N -MRP  0x17

  KEY_M,                        // --N I---  0x18 ь
  KEY_ins,                      // --N I--P  0x19
  KEY_grave,                    // --N I-R-  0x1A ё
  MOD_LCTRL,                    // --N I-RP  0x1B
  KEY__,                        // --N IM--  0x1C
  KEY__,                        // --N IM-P  0x1D
  KEY__,                        // --N IMR-  0x1E '
  ...
  KEY_X,                        // -C- I--P  0x29 ч
  KEY_Q,                        // -C- I-R-  0x2A й
  KEY_smcol,                    // -C- I-RP  0x2B ж
  KEY_V,                        // -C- IM--  0x2C м
  KEY_ping,                     // -C- IM-P  0x2D э
  KEY_F,                        // -C- IMR-  0x2E а
  KEY_J,                        // -C- IMRP  0x2F о
